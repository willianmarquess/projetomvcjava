                ...
                <nav class="navbar-color gradient-45deg-purple-amber">
                    <div class="nav-wrapper">
                        ...
                        <ul id="profile-dropdown" class="dropdown-content">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="<%=request.getContextPath()%>/LogoutUsuarioCTR"  class="grey-text text-darken-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col col s8 m8 l8">
                                    ...
                                    <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown-nav">
                                        <%=usuarioLogado.getNomeUsuario()%><i class="mdi-navigation-arrow-drop-down right"></i></a>
