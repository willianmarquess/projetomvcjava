                ...
                <section id="content">
                    ...
                    <div class="container">
                        ...
                        <div class="card-panel col s12 m6 l6">
                            ...
                            <div class="row">
                                <form class="col s12 m12 l6" action="<%=request.getContextPath()%>/AlterarUsuarioCTR" method="POST">
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input readonly="true" value="${usuario.getIdUsuario()}" placeholder="Digite o nome do cliente" class="validate" value="" id="id" required name="idUsuario" type="text">
                                            <label for="id">ID</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input value="${usuario.getNomeUsuario()}" placeholder="Digite o nome do cliente" class="validate" value="" id="nome" required name="nomeUsuario" type="text">
                                            <label for="nome">Nome</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input value="${usuario.getEmailUsuario()}" placeholder="teste@gmail.com" id="email" required name="emailUsuario" class="validate" type="email">
                                            <label for="email">Email</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input value="${usuario.getSenhaUsuario()}" placeholder="Senha" class="validate" required name="senhaUsuario" id="senha" type="password">
