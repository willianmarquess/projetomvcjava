<%-- 
    ...
    Created on : 31/10/2019, 21:44:25
    Author     : Willian
--%>
...
<html lang="pt-br">
  ...
  <body>
    ...
    <div id="main">
          ...
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                ...
                <li class="bold"><a class="waves-effect waves-cyan">Usuários</a></li>
                <li class="divider"></li>
              </ul>
            </li>
          </ul>
                        ...
                        <div class="container">
                          <div class="row">
                            <div class="col s10 m6 l6">
                              <h5 class="breadcrumbs-title">Listar Cliente</h5>
     ...
     <td><a href="RetornarUsuarioCTR?idUsuario=<%=usuario.getIdUsuario()%>">Editar</a></td>
     <td><a href="ExcluirUsuarioCTR?idUsuario=<%=usuario.getIdUsuario()%>">Excluir</a></td>
